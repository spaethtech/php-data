...
* Full name: `\SpaethTech\Data\Annotations\ColumnNameAnnotation`
...
| Constant | Type | Value |
|:---------|:-----|:------|
|`\SpaethTech\Data\Annotations\ColumnNameAnnotation::SUPPORTED_TARGETS`||\SpaethTech\Annotations\Annotation::TARGET_PROPERTY|
|`\SpaethTech\Data\Annotations\ColumnNameAnnotation::SUPPORTED_DUPLICATES`||false|
...
```php
public ColumnNameAnnotation::parse(array $existing = []): array
```
